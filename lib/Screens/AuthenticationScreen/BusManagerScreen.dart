import 'package:buspay_owner/Screens/AuthenticationScreen/CreateBusScreen.dart';
...
class BusCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Map to associate status with color
      ...
      child: ListTile(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 8), // Add some space between the name and status
            Text(
              status,
              style: TextStyle(
