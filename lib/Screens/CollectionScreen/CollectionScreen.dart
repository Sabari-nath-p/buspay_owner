      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          Container(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: Color.fromRGBO(118,118,128,0.12)),
            child: Row(
          ...
          children: [
            ...
            Container(
              height:26,
              width:32,
              decoration: BoxDecoration(color: Color.fromRGBO(118,181,128,0.12),borderRadius: BorderRadius.circular(6),),
